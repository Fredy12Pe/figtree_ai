...
export default function Header() {
  ...
  return (
    <>
      <header className="relative w-full h-screen overflow-hidden bg-black rounded-b-[28px]">
        {/* Video Background */}
        <video
          ref={videoRef}
          autoPlay
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center">
                  ...
                  <div className="hidden xl:flex items-center space-x-6 xl:space-x-8">
                    <Link href="#" className="text-white text-sm xl:text-base font-medium hover:text-white/80 transition-colors font-inter">
                      AI Toolkit
                    </Link>
                    <Link href="#" className="text-white text-sm xl:text-base font-medium hover:text-white/80 transition-colors font-inter">
                      How It Works
                    ...
                    <Link
                      href="#"
                      className="text-white text-sm xl:text-base font-medium border border-white/80 rounded-lg px-5 py-2.5 transition-all duration-300 hover:bg-white hover:text-black font-inter"
                    >
                      Get In Touch
                    </Link>
                  </div>
